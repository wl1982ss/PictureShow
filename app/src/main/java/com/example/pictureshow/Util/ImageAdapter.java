package com.example.pictureshow.Util;
...
public class ImageAdapter extends BaseAdapter {
    ...
    public void createRefectedBitmap() {
        ...
        for(int i = 0; i < imageIds.length; i++){
            ...
            //LinearGradient shader = new LinearGradient(0, bitmap.getHeight(), 0, bitmap.getHeight(), 0x70ffffff, 0x00ffffff, TileMode.CLAMP);
            paint.setShader(shader);
            //canvas.drawRect(0, height, width, bitmap.getHeight(), paint);
            canvas.drawRect(0, bitmap.getHeight(), width, bitmap.getHeight(), paint);
            ...
            //设置图片大小
            imageView.setLayoutParams(new GalleryFlow.LayoutParams(320, 480));
            //将图片放置在images数组中
            images[i] = imageView;
        }
    }
